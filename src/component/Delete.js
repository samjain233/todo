  ...
  return (
    <>
      {isOpen && (
        ...
        >
          <div className="bg-white border border-2 border-blue-800 bg-cyan-100 w-full lg:w-1/4 rounded-lg">
            <div className="flex justify-end p-4">
              <div onClick={handleClose} className="text-2xl">
                x
              </div>
            </div>
            ...
            <div className=" p-4 rounded shadow-md">
              ...
              <div className="flex justify-center">
                <button
                  ...
                  className=" hover:bg-cyan-800 text-white px-4 py-2 rounded mr-2"
                >
                  Yes
                </button>
                <button
                  onClick={handleClose}
                  className="bg-gray-300 hover:bg-cyan-800 hover:text-white px-4 py-2 rounded"
                >
                  No
                </button>
              </div>
