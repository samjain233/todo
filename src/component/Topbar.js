  ...
  return (
    ...
    <div className='mt-4 w-full flex flex-col md:flex-row justify-center'>
      ...
      <div className="h-10 mb-2  bg-indigo-100 flex rounded-xl border border-indigo-900 border-2 items-center justify-between">
        {/* Sort by label */}
        <span className="flex flex-col justify-center hidden font-bold md:block  lg:block text-purple-800 text-center w-40">Sort By</span>

        {/* Date Created button */}
        <div className="w-full md:w-40 flex flex-col md:rounded-none justify-center hover:bg-cyan-600 text-gray-900 font-bold rounded-tl-lg rounded-bl-lg lg:rounded-none bg-indigo-400 text-white h-full">Date Created</div>

        {/* Due Date button */}
        <div className="w-full md:w-40 flex-col  text-gray-800 hover:bg-cyan-600 hover:h-full font-bold  flex justify-center text-white rounded-br-lg rounded-tr-lg">Due date</div>
      </div>
