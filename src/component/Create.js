...
const Create = ({ setShowCreate }) => {
  ...
  const handleSave = () => {
    ...
    if (form.checkValidity()) {
      ...
      // If the form is invalid, do not close the popup
          ...
          <div className="w-full max-w-md mx-auto rounded-lg">
            ...
            <form id="taskForm">
              ...
              <div className="flex h-10 bg-purple1 items-center justify-between mb-3 rounded-xl">
                ...
                <div className="bg-gray1 w-1/3 text-sm text-white  h-full overflow-hidden rounded-tr-xl flex justify-center items-center hover:bg-blue-200 hover:border-2 hover:border-solid hover:border-blue-500 hover:text-blue-800 rounded-br-xl">
                  <DatePicker
                    id="dueDate"
